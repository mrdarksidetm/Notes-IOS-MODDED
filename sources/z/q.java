...
public final class q<V> extends g<V> {
    ...
    public /* synthetic */ q(int i10, int i11, ae.j jVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void f() {
        if (this.f24079d > 8) {
            Long.compare(md.c0.b(md.c0.b(this.f24080e) * 32) ^ Long.MIN_VALUE, md.c0.b(md.c0.b(this.f24079d) * 25) ^ Long.MIN_VALUE);
        }
        l(z.c(this.f24079d));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x007e, code lost:
        ...
        if (r19.f24100f != 0) goto L23;
     */
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0090, code lost:
    
        if (((r19.f24076a[r1 >> 3] >> ((r1 & 7) << 3)) & 255) != 254) goto L20;
     */
    ...
    */
    private final int g(int r20) {
        /*
            Method dump skipped, instruction units count: 235
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: z.q.g(int):int");
    }
    ...
    private final void i() {
        this.f24100f = z.a(c()) - this.f24080e;
    }
    ...
    private final void k(int i10) {
        ...
        this.f24079d = iMax;
        j(iMax);
        this.f24077b = new int[iMax];
        this.f24078c = new Object[iMax];
    }
