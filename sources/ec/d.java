...
public class d {
    ...
    private Set<String> f10803a;

    public d(List<String> list) {
        this.f10803a = new HashSet(list);
    }

    public d(String[] strArr) {
        this.f10803a = new HashSet(Arrays.asList(strArr));
    }
    ...
    public static d a(Intent intent) {
        ...
        if (intExtra > 0 || (intExtra = intent.getIntExtra("observatory-port", 0)) > 0) {
            ...
            sb2.append(Integer.toString(intExtra));
    ...
    public String[] b() {
        return (String[]) this.f10803a.toArray(new String[this.f10803a.size()]);
    }
}
