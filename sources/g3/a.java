...
public final class a {
    ...
    private static final ThreadLocal<double[]> f11422a = new ThreadLocal<>();
    ...
    public static int c(int i10, int i11) {
        ...
        return Color.argb(iB, d(Color.red(i10), iAlpha2, Color.red(i11), iAlpha, iB), d(Color.green(i10), iAlpha2, Color.green(i11), iAlpha, iB), d(Color.blue(i10), iAlpha2, Color.blue(i11), iAlpha, iB));
    }
