...
public class y0 extends j0 {
    ...
    private static boolean f1955c = false;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final WeakReference<Context> f1956b;

    public y0(Context context, Resources resources) {
        super(resources);
        this.f1956b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = this.f1956b.get();
        return context != null ? i0.g().s(context, this, i10) : a(i10);
    }
