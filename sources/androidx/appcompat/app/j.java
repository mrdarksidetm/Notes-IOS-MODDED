...
class j {
    ...
    private final Deque<WeakReference<XmlPullParser>> f1064a = new ArrayDeque();
    ...
    boolean a(AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f1064a);
        this.f1064a.push(new WeakReference<>(xmlPullParser));
