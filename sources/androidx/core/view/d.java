...
public final class d {
    ...
    public static MenuItem a(MenuItem menuItem, o3.a aVar) {
        if (menuItem instanceof i3.b) {
            return ((i3.b) menuItem).a(aVar);
        }
    ...
    public static void b(MenuItem menuItem, char c10, int i10) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setAlphabeticShortcut(c10, i10);
    ...
    public static void c(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setContentDescription(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void d(MenuItem menuItem, ColorStateList colorStateList) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setIconTintList(colorStateList);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void e(MenuItem menuItem, PorterDuff.Mode mode) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setIconTintMode(mode);
        } else if (Build.VERSION.SDK_INT >= 26) {
            a.j(menuItem, mode);
        }
    }
    ...
    public static void f(MenuItem menuItem, char c10, int i10) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setNumericShortcut(c10, i10);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void g(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof i3.b) {
            ((i3.b) menuItem).setTooltipText(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
