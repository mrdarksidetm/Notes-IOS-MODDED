...
public class WebResourceErrorExt {
    ...
    public static WebResourceErrorExt fromWebResourceError(n nVar) {
        return new WebResourceErrorExt(s.a("WEB_RESOURCE_ERROR_GET_CODE") ? nVar.b() : -1, s.a("WEB_RESOURCE_ERROR_GET_DESCRIPTION") ? nVar.a().toString() : "");
    }
    ...
    public Map<String, Object> toMap() {
        ...
        map.put(b.f7429c, getDescription());
        return map;
    }
