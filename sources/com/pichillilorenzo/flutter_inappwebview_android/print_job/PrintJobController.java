...
public class PrintJobController implements Disposable {
    ...
    public PrintJobController(String str, PrintJob printJob, PrintJobSettings printJobSettings, InAppWebViewFlutterPlugin inAppWebViewFlutterPlugin) {
        ...
        this.channelDelegate = new PrintJobChannelDelegate(this, new j(inAppWebViewFlutterPlugin.messenger, METHOD_CHANNEL_NAME_PREFIX + str));
    }
    ...
    public void dispose() {
        ...
        if (inAppWebViewFlutterPlugin != null && (printJobManager = inAppWebViewFlutterPlugin.printJobManager) != null && printJobManager.jobs.containsKey(this.f9075id)) {
            printJobManager.jobs.put(this.f9075id, null);
        }
        PrintJob printJob = this.job;
        if (printJob != null) {
            printJob.cancel();
