...
public class PullToRefreshLayout extends b implements Disposable {
    ...
    public PullToRefreshLayout(Context context, InAppWebViewFlutterPlugin inAppWebViewFlutterPlugin, Object obj, PullToRefreshSettings pullToRefreshSettings) {
        ...
        this.channelDelegate = new PullToRefreshChannelDelegate(this, new j(inAppWebViewFlutterPlugin.messenger, METHOD_CHANNEL_NAME_PREFIX + obj));
    }
    ...
    public void prepare() {
        ...
        setOnChildScrollUpCallback(new b.i() { // from class: com.pichillilorenzo.flutter_inappwebview_android.pull_to_refresh.PullToRefreshLayout.1
            @Override // androidx.swiperefreshlayout.widget.b.i
            public boolean canChildScrollUp(b bVar, View view) {
        ...
        setOnRefreshListener(new b.j() { // from class: com.pichillilorenzo.flutter_inappwebview_android.pull_to_refresh.PullToRefreshLayout.2
