...
public final class ButtonComponent$Destination$Url$$serializer implements c0<ButtonComponent.Destination.Url> {
    ...
    public b<?>[] childSerializers() {
        return new b[]{n1.f790a, ButtonComponent.Destination.Url.$childSerializers[1]};
    }
    ...
    public ButtonComponent.Destination.Url deserialize(e eVar) {
        ...
        b[] bVarArr = ButtonComponent.Destination.Url.$childSerializers;
        if (cVarC.x()) {
        ...
        cVarC.d(descriptor2);
        return new ButtonComponent.Destination.Url(i10, strM, (ButtonComponent.UrlMethod) objK, null);
    }
    ...
    @Override // we.h
    public void serialize(ze.f fVar, ButtonComponent.Destination.Url url) {
        r.f(fVar, "encoder");
        r.f(url, "value");
        f descriptor2 = getDescriptor();
        d dVarC = fVar.c(descriptor2);
        ButtonComponent.Destination.Url.write$Self(url, dVarC, descriptor2);
        dVarC.d(descriptor2);
    }
