...
public final class ComponentOverrides$$serializer<T> implements c0<ComponentOverrides<T>> {
    ...
    public ComponentOverrides<T> deserialize(e eVar) {
        ...
        if (cVarC.x()) {
            ...
            Object objL4 = cVarC.l(descriptor, 1, ComponentStates.Companion.serializer(this.typeSerial0), null);
            objL2 = cVarC.l(descriptor, 2, ComponentConditions.Companion.serializer(this.typeSerial0), null);
            i10 = 7;
            obj = objL4;
        } else {
            Object objL5 = null;
            ...
            while (z10) {
                ...
                if (iZ == -1) {
                    ...
                    objL5 = cVarC.l(descriptor, 1, ComponentStates.Companion.serializer(this.typeSerial0), objL5);
                    i11 |= 2;
                } else {
                    if (iZ != 2) {
                        throw new j(iZ);
                    }
                    objL6 = cVarC.l(descriptor, 2, ComponentConditions.Companion.serializer(this.typeSerial0), objL6);
                    i11 |= 4;
                }
            }
            obj = objL5;
        ...
        cVarC.d(descriptor);
        return new ComponentOverrides<>(i10, (PartialComponent) objL, (ComponentStates) obj, (ComponentConditions) objL2, (j1) null);
    }
    ...
    @Override // we.h
    public void serialize(ze.f fVar, ComponentOverrides<T> componentOverrides) {
        r.f(fVar, "encoder");
        r.f(componentOverrides, "value");
        f descriptor = getDescriptor();
        d dVarC = fVar.c(descriptor);
        ComponentOverrides.write$Self(componentOverrides, dVarC, descriptor, this.typeSerial0);
        dVarC.d(descriptor);
    }
