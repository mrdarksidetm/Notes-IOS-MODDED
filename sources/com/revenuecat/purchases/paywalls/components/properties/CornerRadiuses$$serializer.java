...
public final class CornerRadiuses$$serializer implements c0<CornerRadiuses> {
    ...
    static {
        ...
        a1 a1Var = new a1("com.revenuecat.purchases.paywalls.components.properties.CornerRadiuses", cornerRadiuses$$serializer, 4);
    ...
    public CornerRadiuses deserialize(e eVar) {
        ...
        cVarC.d(descriptor2);
        return new CornerRadiuses(i10, d11, d10, d12, dY, null);
    }
    ...
    @Override // we.h
    public void serialize(ze.f fVar, CornerRadiuses cornerRadiuses) {
        r.f(fVar, "encoder");
        r.f(cornerRadiuses, "value");
        f descriptor2 = getDescriptor();
        d dVarC = fVar.c(descriptor2);
        CornerRadiuses.write$Self(cornerRadiuses, dVarC, descriptor2);
        dVarC.d(descriptor2);
    }
