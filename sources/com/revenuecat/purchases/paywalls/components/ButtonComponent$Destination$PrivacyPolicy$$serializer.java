...
public final class ButtonComponent$Destination$PrivacyPolicy$$serializer implements c0<ButtonComponent.Destination.PrivacyPolicy> {
    ...
    public b<?>[] childSerializers() {
        return new b[]{n1.f790a, ButtonComponent.Destination.PrivacyPolicy.$childSerializers[1]};
    }
    ...
    public ButtonComponent.Destination.PrivacyPolicy deserialize(e eVar) {
        ...
        b[] bVarArr = ButtonComponent.Destination.PrivacyPolicy.$childSerializers;
        if (cVarC.x()) {
        ...
        cVarC.d(descriptor2);
        return new ButtonComponent.Destination.PrivacyPolicy(i10, strM, (ButtonComponent.UrlMethod) objK, null);
    }
    ...
    @Override // we.h
    public void serialize(ze.f fVar, ButtonComponent.Destination.PrivacyPolicy privacyPolicy) {
        r.f(fVar, "encoder");
        r.f(privacyPolicy, "value");
        f descriptor2 = getDescriptor();
        d dVarC = fVar.c(descriptor2);
        ButtonComponent.Destination.PrivacyPolicy.write$Self(privacyPolicy, dVarC, descriptor2);
        dVarC.d(descriptor2);
    }
