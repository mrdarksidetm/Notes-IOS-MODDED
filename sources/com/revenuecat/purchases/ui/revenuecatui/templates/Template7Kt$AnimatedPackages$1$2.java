...
final class Template7Kt$AnimatedPackages$1$2 extends s implements q<e, l, Integer, i0> {
    ...
    Template7Kt$AnimatedPackages$1$2(List<TemplateConfiguration.PackageInfo> list, PaywallState.Loaded.Legacy legacy, PaywallViewModel paywallViewModel, TemplateConfiguration.Colors colors, int i10) {
        super(3);
        this.$packages = list;
        this.$state = legacy;
    ...
    public final void invoke(e eVar, l lVar, int i10) {
        ...
        if (o.I()) {
            o.U(469640179, i10, -1, "com.revenuecat.purchases.ui.revenuecatui.templates.AnimatedPackages.<anonymous>.<anonymous> (Template7.kt:471)");
        }
        b bVar = b.f11594a;
        ...
        while (it.hasNext()) {
            Template7Kt.SelectPackageButton(iVar, legacy, (TemplateConfiguration.PackageInfo) it.next(), paywallViewModel, colors, lVar, 582 | ((i11 << 6) & 7168) | (57344 & i11));
        }
        lVar.K();
        lVar.K();
        lVar.L();
