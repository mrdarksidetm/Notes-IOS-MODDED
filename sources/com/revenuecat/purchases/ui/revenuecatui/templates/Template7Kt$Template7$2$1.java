...
final class Template7Kt$Template7$2$1 extends s implements l<TemplateConfiguration.TierInfo, i0> {
    final /* synthetic */ k1<TemplateConfiguration.TierInfo> $selectedTier$delegate;
    final /* synthetic */ PaywallState.Loaded.Legacy $state;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    Template7Kt$Template7$2$1(PaywallState.Loaded.Legacy legacy, k1<TemplateConfiguration.TierInfo> k1Var) {
        super(1);
        this.$state = legacy;
