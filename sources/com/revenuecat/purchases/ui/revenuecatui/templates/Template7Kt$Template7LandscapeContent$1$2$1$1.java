...
final class Template7Kt$Template7LandscapeContent$1$2$1$1 extends s implements l<TemplateConfiguration.TierInfo, i0> {
    final /* synthetic */ l<TemplateConfiguration.TierInfo, i0> $onSelectTierChange;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    Template7Kt$Template7LandscapeContent$1$2$1$1(l<? super TemplateConfiguration.TierInfo, i0> lVar) {
        super(1);
