...
final class Template3Kt$Features$1 extends s implements p<l, Integer, i0> {
    ...
    Template3Kt$Features$1(h hVar, PaywallState.Loaded.Legacy legacy, float f10, int i10) {
        super(2);
