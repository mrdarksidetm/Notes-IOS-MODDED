...
final class PurchaseLogicWithCallback$performPurchase$2$1 extends s implements l<PurchaseLogicResult, i0> {
    final /* synthetic */ d<PurchaseLogicResult> $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    PurchaseLogicWithCallback$performPurchase$2$1(d<? super PurchaseLogicResult> dVar) {
        super(1);
