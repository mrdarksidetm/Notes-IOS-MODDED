...
final class zzhv {
    ...
    zzhv(String str, char[] cArr) {
        ...
        for (int i10 = 0; i10 < cArr.length; i10++) {
            char c10 = cArr[i10];
            boolean z10 = true;
            zzgx.zzc(c10 < 128, "Non-ASCII character: %s", c10);
            if (bArr[c10] != -1) {
                z10 = false;
            }
            zzgx.zzc(z10, "Duplicate character: %s", c10);
            bArr[c10] = (byte) i10;
        }
    ...
    private zzhv(String str, char[] cArr, byte[] bArr, boolean z10) {
        ...
        try {
            ...
            int iZzb = zzib.zzb(length, RoundingMode.UNNECESSARY);
            this.zzb = iZzb;
    ...
    final int zzb(char c10) throws zzhx {
        if (c10 > 127) {
