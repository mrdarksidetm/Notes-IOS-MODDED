...
public final class zzga implements zzfe {
    ...
    public final Object zzb(Object obj, Object obj2) throws zzby {
        ...
        if (z14 && (obj2 instanceof byte[])) {
            ...
            i iVarT = o.t(0, length3);
            ArrayList arrayList11 = new ArrayList(v.x(iVarT, 10));
        ...
        if (z15 && (obj2 instanceof short[])) {
            ...
            i iVarT2 = o.t(0, length4);
            ArrayList arrayList12 = new ArrayList(v.x(iVarT2, 10));
        ...
        if (z16 && (obj2 instanceof int[])) {
            ...
            i iVarT3 = o.t(0, length5);
            ArrayList arrayList13 = new ArrayList(v.x(iVarT3, 10));
        ...
        i iVarT4 = o.t(0, length6);
        ArrayList arrayList14 = new ArrayList(v.x(iVarT4, 10));
