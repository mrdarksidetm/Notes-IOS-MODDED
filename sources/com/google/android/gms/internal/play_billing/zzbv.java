...
final class zzbv extends zzby {
    ...
    zzbv(byte[] bArr, int i10, int i11) {
        super(null);
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzb(byte b10) throws zzbw {
        try {
            byte[] bArr = this.zzb;
            int i10 = this.zzd;
            this.zzd = i10 + 1;
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzd(int i10, boolean z10) throws zzbw {
        zzq(i10 << 3);
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzf(int i10, int i11) throws zzbw {
        zzq((i10 << 3) | 5);
        zzg(i11);
    }

    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzg(int i10) throws zzbw {
        try {
            byte[] bArr = this.zzb;
            int i11 = this.zzd;
            int i12 = i11 + 1;
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzh(int i10, long j10) throws zzbw {
        zzq((i10 << 3) | 1);
        zzi(j10);
    }

    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzi(long j10) throws zzbw {
        try {
            byte[] bArr = this.zzb;
            int i10 = this.zzd;
            int i11 = i10 + 1;
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzj(int i10, int i11) throws zzbw {
        zzq(i10 << 3);
        zzk(i11);
    }

    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzk(int i10) throws zzbw {
        if (i10 >= 0) {
            zzq(i10);
        } else {
            zzs(i10);
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzm(int i10, String str) throws zzbw {
        zzq((i10 << 3) | 2);
        zzn(str);
    }

    public final void zzn(String str) throws zzbw {
        int i10 = this.zzd;
        try {
            ...
            int i12 = i10 + iZzw2;
            this.zzd = i12;
            int iZzb = zzfu.zzb(str, this.zzb, i12, this.zzc - i12);
            this.zzd = i10;
            zzq((iZzb - i10) - iZzw2);
            this.zzd = iZzb;
        } catch (zzft e10) {
    ...
    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzr(int i10, long j10) throws zzbw {
        zzq(i10 << 3);
        zzs(j10);
    }

    @Override // com.google.android.gms.internal.play_billing.zzby
    public final void zzs(long j10) throws zzbw {
