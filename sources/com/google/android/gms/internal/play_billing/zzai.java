...
public abstract class zzai extends zzaf implements List, RandomAccess {
    ...
    static zzai zzi(Object[] objArr, int i10) {
        return i10 == 0 ? zzao.zza : new zzao(objArr, i10);
    }
    ...
    public zzai subList(int i10, int i11) {
        ...
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzao.zza : new zzah(this, i10, i12);
    }
    ...
    public final zzaw listIterator(int i10) {
        ...
        return isEmpty() ? zza : new zzag(this, i10);
    }
}
