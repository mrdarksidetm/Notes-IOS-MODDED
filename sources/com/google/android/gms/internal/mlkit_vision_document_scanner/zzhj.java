...
final class zzhj implements d {
    ...
    static {
        ...
        c.b bVarA4 = c.a("documentPresenceConfidence");
        zzar zzarVar4 = new zzar();
        zzarVar4.zza(4);
        zze = bVarA4.b(zzarVar4.zzb()).a();
        c.b bVarA5 = c.a("documentCornerConfidence");
        zzar zzarVar5 = new zzar();
        zzarVar5.zza(5);
        zzf = bVarA5.b(zzarVar5.zzb()).a();
        c.b bVarA6 = c.a("documentRotationSuggestionDegrees");
        zzar zzarVar6 = new zzar();
        zzarVar6.zza(6);
        zzg = bVarA6.b(zzarVar6.zzb()).a();
        c.b bVarA7 = c.a("documentRotationSuggestionConfidence");
