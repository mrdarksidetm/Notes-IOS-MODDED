...
public enum zzml implements zzat {
    ...
    CLOUD_TEXT_CREATE(R.styleable.AppCompatTheme_windowFixedHeightMinor),
    CLOUD_TEXT_DETECT(R.styleable.AppCompatTheme_windowFixedWidthMajor),
    CLOUD_TEXT_CLOSE(R.styleable.AppCompatTheme_windowFixedWidthMinor),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID(RCHTTPStatusCodes.UNAUTHORIZED),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(402),
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(RCHTTPStatusCodes.FORBIDDEN),
