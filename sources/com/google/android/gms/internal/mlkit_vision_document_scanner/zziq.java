...
final class zziq implements d {
    ...
    static {
        ...
        c.b bVarA2 = c.a("multipleObjectsEnabled");
        zzar zzarVar2 = new zzar();
        zzarVar2.zza(2);
        zzc = bVarA2.b(zzarVar2.zzb()).a();
        c.b bVarA3 = c.a("classificationEnabled");
        zzar zzarVar3 = new zzar();
        zzarVar3.zza(3);
        zzd = bVarA3.b(zzarVar3.zzb()).a();
        c.b bVarA4 = c.a("maxPerObjectLabelCount");
        zzar zzarVar4 = new zzar();
        zzarVar4.zza(4);
        zze = bVarA4.b(zzarVar4.zzb()).a();
        c.b bVarA5 = c.a("classificationConfidenceThreshold");
        zzar zzarVar5 = new zzar();
        zzarVar5.zza(5);
        zzf = bVarA5.b(zzarVar5.zzb()).a();
        c.b bVarA6 = c.a("customLocalModelOptions");
