...
final class zzakr extends zzaij<Long> implements RandomAccess {
    ...
    private zzakr(long[] jArr, int i10, boolean z10) {
        super(z10);
        this.zzb = jArr;
        this.zzc = i10;
    }
    ...
    public final /* synthetic */ zzakc zza(int i10) {
        if (i10 >= this.zzc) {
            return new zzakr(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
