...
final class zzajx extends zzaij<Float> implements RandomAccess {
    ...
    private zzajx(float[] fArr, int i10, boolean z10) {
        super(z10);
        this.zzb = fArr;
        this.zzc = i10;
    }
    ...
    public final /* synthetic */ zzakc zza(int i10) {
        if (i10 >= this.zzc) {
            return new zzajx(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
