...
final class zzaji extends zzaij<Double> implements RandomAccess {
    ...
    private zzaji(double[] dArr, int i10, boolean z10) {
        super(z10);
        this.zzb = dArr;
        this.zzc = i10;
    }
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i10 = 0; i10 < this.zzc; i10++) {
            iZza = (iZza * 31) + zzakb.zza(Double.doubleToLongBits(this.zzb[i10]));
        }
        return iZza;
    }
    ...
    public final /* synthetic */ zzakc zza(int i10) {
        if (i10 >= this.zzc) {
            return new zzaji(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
