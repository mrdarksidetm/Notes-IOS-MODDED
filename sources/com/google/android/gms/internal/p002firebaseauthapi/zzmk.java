    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzmnVarZza = zza(zzmnVarZza, zzmnVarZza2, a10, bigIntegerZza);
                zzmnVarZza2 = zza(zzmnVarZza2, a10, bigIntegerZza);
            } else {
                zzmnVarZza2 = zza(zzmnVarZza, zzmnVarZza2, a10, bigIntegerZza);
                zzmnVarZza = zza(zzmnVarZza, a10, bigIntegerZza);
            }
        }
        if (zzmnVarZza.zza()) {
