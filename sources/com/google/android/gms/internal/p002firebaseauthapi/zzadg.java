...
public final class zzadg {
    ...
    public static u zza(FirebaseAuth firebaseAuth, zzzl zzzlVar, a0 a0Var) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzzlVar);
        Pair<String, String> pair = zza.get(17078);
        return new u((String) pair.first, (String) pair.second, m.C(zzzlVar, firebaseAuth, a0Var));
    }
    ...
    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.z())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.z());
    }
    ...
    */
    public static x9.l zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadg.zza(com.google.android.gms.common.api.Status):x9.l");
    }

    public static l zza(Status status, h hVar, String str, String str2) {
        int iX = status.x();
        if (iX == 17012 || iX == 17007 || iX == 17025) {
            return new x(zza(iX), zza(zzb(iX), status)).d(hVar).e(str);
        }
        return zza(status);
    }
