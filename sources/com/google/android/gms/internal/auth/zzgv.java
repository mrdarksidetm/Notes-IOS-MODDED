...
class zzgv extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i10 = 0;
        if (size >= 0) {
            int iCompareTo = comparable.compareTo(((zzgp) this.zzb.get(size)).zza());
            if (iCompareTo > 0) {
                return -(size + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i10 <= size) {
            int i11 = (i10 + size) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i11)).zza());
            if (iCompareTo2 < 0) {
                size = i11 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (iZzb == zzgvVar.zzb()) {
            ...
            objEntrySet2 = zzgvVar.zzc;
        } else {
            objEntrySet = entrySet();
            objEntrySet2 = zzgvVar.entrySet();
        }
